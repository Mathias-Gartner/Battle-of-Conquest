...
<?php
	if (isset($_GET['foot']))
	{
		...
		case "fh":
			?>
			<div class='title flex_centered'>FH Technikum</div>
		...
		case "team":
			?>
			<div class='title flex_centered'>The team</div>
			<div class='flex_centered' id='team'><img src='res/foto/teamfoto2.jpg' alt='team'></div>
			<?php
			break;
		case "help":
			?>
			<div class='title flex_centered'>The Manual</div>
		...
		case "imp":
			?>
			<div class='title flex_centered'>Legal notice</div>
