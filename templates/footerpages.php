...
<?php
	if (isset($_GET['foot']))
	{
		...
		case "fh":
			...
			<header>
				<h2 class='flex_centered'>FH Technikum</h2>
			</header>
		...
		case "team":
			...
			<article id="welcome" class="panel">
			<header>
				<h2 class='flex_centered'>The Team</h2>
			</header>
				<div class='flex_centered' id='team'>
					<img src='res/foto/teamfoto2.jpg' alt='team'>
				</div>
			</article>
			<?php
			break;
		case "help":
			...
			<article id="welcome" class="panel">
			<header>
				<h2 class='flex_centered'>The Manual</h2>
			</header>
		...
		case "imp":
			...
			<article id="welcome" class="panel">
			<header>
				<h2 class='flex_centered'>Legal notice</h2>
			</header>
			<p>Creator of content and person in charge: Markus Krammer<br />
			   FH Technikum<br />
			2013/2014
			</p>
