<?php include 'header.php' ?>
  ...
  <div class='content cont middle'>
    <div class='centered user'>Willkommen <?php echo $_SESSION['username']; ?>!</div>
    <div class='centered linkbar'>
      <div class='centered box-padding'>
    ...
    <div class="centered cont" id="overview">
      Du hast derzeit
      <?php
