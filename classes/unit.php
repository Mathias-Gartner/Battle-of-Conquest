...
Unit::setPK("unit_id");
Unit::hasMany("districtUnits", array("class_name"=>"\Classes\DistrictUnit", "foreign_key"=>"unit_id"));
Unit::hasMany("attackUnits", array("class_name"=>"\Classes\AttackingUnit", "foreign_key"=>"unit_id"));
Unit::hasMany("defendUnits", array("class_name"=>"\Classes\DefendingUnit", "foreign_key"=>"unit_id"));
